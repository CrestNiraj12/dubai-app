...
@section('content')
    ...
    <div class="container" style="border-top-width: 200px;padding-top: 200px;padding-bottom: 50px;">
      ...
      <form>
          ...
          <div class="zip-code-group form-group">
              ...
              <div class="input-container">
                  ...
                  <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal cod
                  e for your credit card billing address."></a>
              </div>
          </div>
