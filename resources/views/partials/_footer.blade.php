                                ...
                                <ul class="footer-text-all">
                                  <!--   <li><a href="{{url('pearson-hnd-hnc')}}">Pearson HND & HNC</a></li> -->
                                             <!--   <li><a href="{{url('tquk-hnd-hnc')}}">TQUK HND & HNC </a></li> -->
                                                ...
                                                <li><a href="{{url('tquk-lvl-2-ba-rqf')}}">Business Administration UK Qualification, Level 2</a></li>
                                                <li><a href="{{url('tquk-lvl-3-ba')}}">Business Administration UK Qualification, Level 3 </a></li>
                                                <li><a href="{{url('tquk-lvl-3-ba-rqf')}}">Business Management UK Qualification, Level 4 & 5</a></li>
